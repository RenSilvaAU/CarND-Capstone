...
class DBWNode(object):
    def __init__(self):
        ...
        # TODO-DONE: Create `Controller` object
        ...
        # TODO-DONE: Subscribe to all the topics you need to
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            # TODO-DONE: Get predicted throttle, brake, and steering using `twist_controller`
